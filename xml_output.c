...
int output_value(Output *o, void *value)
{
  ...
  switch (type & 0xf)
  {
    case XS_STRING:
      if (n)
        return output_escaped(o, value);
    case XS_ANY_URI:
      return output_escaped(o, *(char **)value);
    case XS_BOOLEAN:
      return ((*(uint32_t *)value) & (1 << o->flag)) ? output_string(o, "true") : output_string(o, "false");
    case XS_HEX_BINARY:
...
int output_quoted(Output *o, void *value)
{
  ...
  else if (output_char(o, '\"') && output_value(o, value) && output_char(o, '\"'))
    return 1;
  *last = '\0';
  o->ptr = last;
  return 0;
    ...
    case SE_COMPLEX:
      if (output_break(o, "<%s", name))
      {
        if (o->first)
        {
          ...
          if (ns && !output_string(o, " xmlns=\"%s\"", ns))
            return 0;
          o->first = 0;
        }
        o->open = 1;
...
const OutputDriver xml_output = {output_event, output_quoted, output_value, output_done};
