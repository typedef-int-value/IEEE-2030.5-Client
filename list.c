...
#define link_insert(head, l) ((list_next(l) = (void *)head), (head = (void *)l))
#define foreach(l, head) for (l = (void *)head; l != NULL; l = (void *)list_next(l))
