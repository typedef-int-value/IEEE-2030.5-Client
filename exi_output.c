...
int exi_output_string(Output *o, const SchemaElement *se, char *s)
{
  ...
  StringTable *t = find_table(o->local, name);
  int i, part, bits;
  if (t)
  {
    i = find_string(t, s);
    ...
    t = o->local = new_string_table(o->local, name, 8);
...
int exi_output_value(Output *o, void *value)
{
  ...
  switch (type & 0xf)
  {
    case XS_STRING:
      if (n)
        return exi_output_string(o, o->se, value);
    case XS_ANY_URI:
      return exi_output_string(o, o->se, *(char **)value);
    case XS_BOOLEAN:
      output_bit(o, ((*(uint32_t *)value) >> o->flag) & 1);
      break;
    case XS_HEX_BINARY:
      return output_binary(o, value, n);
    case XS_LONG:
      output_integer(o, *(int64_t *)value);
      break;
    case XS_INT:
      output_integer(o, *(int32_t *)value);
      break;
    case XS_SHORT:
      output_integer(o, *(int16_t *)value);
      break;
    case XS_BYTE:
      output_bits(o, (*(int8_t *)value) + 128, 8);
      break;
    case XS_ULONG:
      output_uint(o, *(uint64_t *)value);
      break;
    case XS_UINT:
      output_uint(o, *(uint32_t *)value);
      break;
    case XS_USHORT:
      output_uint(o, *(uint16_t *)value);
      break;
    case XS_UBYTE:
      output_bits(o, *(uint8_t *)value, 8);
      break;
  }
  return 1;
}
...
{
  free_tables(o->global);
  free_tables(o->local);
}

const OutputDriver exi_output = {exi_output_event, exi_output_value, exi_output_simple, exi_output_done};
